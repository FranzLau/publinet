  ...
  <body id="page-top">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><i class="fa-solid fa-store mr-2"></i>Ventas</h1>
              <div class="d-none d-sm-inline-block">
                <a href="ventanueva.php" class="btn btn-sm btn-primary shadow-sm">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $('#tablaVentas').load('../componentes/tablaVentas.php');
      });
    </script>
